...
class LDVDataset(data.Dataset):
    ...
    def __init__(self, opt):
        super(LDVDataset, self).__init__()
        self.opt = opt
        ...
        if opt['val_partition'] == 'LDV':
            val_partition = ['195', '198']
        ...
        val_partition1 = ['190','191','192','193','194','195','196','197','198','199','200']
        self.keys = [
            v for v in self.keys if v.split('/')[0] not in val_partition1
        ]
